...
GO
ALTER TABLE [webuser].[Users] ADD CONSTRAINT [FK_Users_Companies] FOREIGN KEY ([Company]) REFERENCES [webuser].[Companies] ([Id])
GO
ALTER TABLE [webuser].[Users] ADD CONSTRAINT [FK_Users_Pages] FOREIGN KEY ([DefaultPage]) REFERENCES [webuser].[Pages] ([id])
GO
ALTER TABLE [webuser].[Users] ADD CONSTRAINT [FK_Users_VariousTypes1] FOREIGN KEY ([Position]) REFERENCES [webuser].[VariousTypes] ([id])
GO
