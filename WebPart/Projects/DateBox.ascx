        ...
        <td>
            <table id="tblDate" runat="server">
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><asp:Image Runat="server" Enabled="True" ID="imgButton" onmouseover="this.style.cursor='pointer'" ToolTip="Πατήστε εδώ για να εμφανιστεί το ημερολόγιο" EnableViewState="False" BorderWidth="0px" ImageAlign="AbsMiddle"></asp:Image></td>
                </tr>
            </table>
        </td>
        <td>&nbsp;</td>
